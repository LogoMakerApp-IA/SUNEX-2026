    ...
    <div className="flex-1 flex flex-col items-center justify-center p-6 relative w-full overflow-hidden">
      ...
      <div className="glass-panel text-center p-12 max-w-[420px] w-full animate-in fade-in zoom-in-95 duration-500 shadow-2xl shadow-black">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button type="submit" disabled={loading} className="btn-primary mt-6 !py-5">
            Autenticar
          </button>
        </form>
        ...
        <div className="relative mt-8 mb-6">
          ...
          <div className="relative flex justify-center text-xs uppercase tracking-widest">
            <span className="bg-[#121214] px-4 text-[#888] font-bold">Ou</span>
          </div>
        </div>
        ...
        <button 
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-[#1A1A1D] hover:bg-[#2A2A2E] border border-white/5 text-white/80 py-4 px-6 rounded-xl font-bold uppercase tracking-widest transition-all duration-300 disabled:opacity-50"
        >
